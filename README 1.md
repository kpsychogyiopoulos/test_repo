...
- __jira-master.zip__ : The folder containing the source code.
...
- __jira-master/__ : Hosts the source code and modular Python scripts required for system operation.
...
To run this project, you need to use runtime environment with Python 3.11 and Spark 3.5 and install the libraries contained within the ```requirements.txt``` file stored at ```project_data_assets/data_asset```:  
